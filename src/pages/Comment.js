...
<Col className="mt-1" >
    ...
    <Table className='text-nowrap text-center border-bottom' responsive>
      ...
      تات
                ...
                <td>
                <Button.Ripple color='flat-success'>تاییدشده</Button.Ripple>
   ...
   تننتن
      ...
      <UncontrolledPopover placement='bottom' target='popBottom'>
        ...
        <PopoverBody><Edit size={12} className="pl-1 "/> رد کردن</PopoverBody>
        <PopoverBody><Trash2  size={12} className="pl-1"/>  حذف</PopoverBody>
        <PopoverBody><Edit2  size={12} className="pl-1"/>  پاسخ </PopoverBody>
      </UncontrolledPopover>
